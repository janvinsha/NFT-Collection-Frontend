  ...
  return (
    <div className="App">
      <div className="container">
        ...
        {currentAccount === "" ?"":   <p className="sub-text">{nftAmount}/100 NFTs minted so far</p>}
          {currentAccount === "" ? renderNotConnectedContainer() : renderMintUI()}
          <p><a  className="footer-text"href="https://testnets.opensea.io/collection/coolerenyeagernft-v2"> 🌊 View Collection on OpenSea</a></p>
        </div>
